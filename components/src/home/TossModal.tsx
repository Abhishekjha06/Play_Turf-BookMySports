        ...
        <AnimatePresence>
            {open && (
                ...
                >
                    ...
                    <motion.div
                        onClick={doToss}
                        className={`relative z-10 w-full max-w-[360px] rounded-[2rem] border border-white/10 overflow-hidden 
                                    bg-[#0f172a] shadow-2xl flex flex-col items-center
                    ...
                    >
                        ...
                        {/* Coin Section */}
                        <div className="py-10 flex items-center justify-center perspective-1000">
